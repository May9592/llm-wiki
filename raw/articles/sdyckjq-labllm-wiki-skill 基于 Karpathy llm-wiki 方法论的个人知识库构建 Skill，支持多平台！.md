...
> [原文链接](https://github.com/sdyckjq-lab/llm-wiki-skill)
...
- Claude Code: [platforms/claude/CLAUDE.md](https://github.com/sdyckjq-lab/llm-wiki-skill/blob/main/platforms/claude/CLAUDE.md)
- Codex: [platforms/codex/AGENTS.md](https://github.com/sdyckjq-lab/llm-wiki-skill/blob/main/platforms/codex/AGENTS.md)
- OpenClaw: [platforms/openclaw/README.md](https://github.com/sdyckjq-lab/llm-wiki-skill/blob/main/platforms/openclaw/README.md)
...
- **[baoyu-url-to-markdown](https://github.com/JimLiu/baoyu-skills#baoyu-url-to-markdown)** - by [JimLiu](https://github.com/JimLiu) 网页文章、X/Twitter 等内容提取，通过 Chrome CDP 渲染并转换为 markdown
