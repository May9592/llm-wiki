---
type: "article"
source_url: "https://github.com/safishamsi/graphify/blob/v3/README.zh-CN.md"
author:
published:
...
tags:
  - "clippings"
---
# Commits · safishamsi/graphify

> [原文链接](https://github.com/safishamsi/graphify/blob/v3/README.zh-CN.md)

## 摘要

## graphify

[English](https://github.com/safishamsi/graphify/blob/v3/README.md) | [简体中文](https://github.com/safishamsi/graphify/blob/v3/README.zh-CN.md)
...
如果知识图谱存在，Claude 会先看到： *"graphify: Knowledge graph exists. Read graphify-out/GRAPH\_REPORT.md for god nodes and community structure before searching raw files."* —— 这样 Claude 会优先按图谱导航，而不是一上来就 grep 整个项目。
...
| 语料 | 文件数 | 压缩比 | 输出 |
| --- | --- | --- | --- |
| Karpathy 的仓库 + 5 篇论文 + 4 张图片 | 52 | **71.5x** | [`worked/karpathy-repos/`](https://github.com/safishamsi/graphify/blob/v3/worked/karpathy-repos) |
| graphify 源码 + Transformer 论文 | 4 | **5.4x** | [`worked/mixed-corpus/`](https://github.com/safishamsi/graphify/blob/v3/worked/mixed-corpus) |
| httpx（合成 Python 库） | 6 | ~1x | [`worked/httpx/`](https://github.com/safishamsi/graphify/blob/v3/worked/httpx) |
...
模块职责和新增语言的方法见 [ARCHITECTURE.md](https://github.com/safishamsi/graphify/blob/v3/ARCHITECTURE.md) 。
