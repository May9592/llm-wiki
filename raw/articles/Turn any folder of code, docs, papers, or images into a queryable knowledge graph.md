...
| --- | --- | --- | --- |
| Karpathy repos + 5 papers + 4 images | 52 | **71.5x** | [`worked/karpathy-repos/`](https://github.com/safishamsi/graphify/blob/v3/worked/karpathy-repos) |
| graphify source + Transformer paper | 4 | **5.4x** | [`worked/mixed-corpus/`](https://github.com/safishamsi/graphify/blob/v3/worked/mixed-corpus) |
| httpx (synthetic Python library) | 6 | ~1x | [`worked/httpx/`](https://github.com/safishamsi/graphify/blob/v3/worked/httpx) |
...
See [ARCHITECTURE.md](https://github.com/safishamsi/graphify/blob/v3/ARCHITECTURE.md) for module responsibilities and how to add a language.
